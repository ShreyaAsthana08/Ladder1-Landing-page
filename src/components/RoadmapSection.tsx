...
const RoadmapCard: React.FC<RoadmapCardProps> = ({ src, alt, label, className }) => {
  ...
  return (
    ...
    >
      ...
      />
      {isHovered && (
        <div className="absolute -top-1 ml-20  z-50 animate-in fade-in slide-in-from-bottom-2 duration-200">
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-[700px] flex items-center justify-center">
            ...
            {/* Roadmap Cards positioned along the path */}
            <RoadmapCard
